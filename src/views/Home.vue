<template>
  <div style="position: relative; height: 100%;">
      ...
      >
        <div class="d-flex flex-column px-8 py-4 pr-md-16 pa-md-10">
          ...
          <p class="main-text white--text text-justify">
            Somos as psicólogas <strong>Natália Ribeiro</strong> (CRP 01/2359-3)
            e <strong>Ruth Braga</strong> (CRP 01/2077-4) e estamos
            disponibilizando vagas para atendimento social online.
          </p>

          <p class="main-text white--text text-justify">
            Decidimos criar este projeto com o intuito de viabilizar acesso à
            psicoterapia a pessoas em situação de vulnerabilidade financeira e
            devolver a sociedade conhecimentos adquiridos na nossas formações.
          </p>
    ...
    <div
      class="d-flex flex-column flex-md-row align-center justify-center container-spacing pt-10 pb-md-10"
    >
      <div class="col-content-start">
        <h1
          id="left-side-title"
          class="text-center font-weight-bold secondary-color"
        >
      ...
      <div class="d-flex flex-column py-5 px-8 ml-md-10 col-content-end">
        ...
        <p class="main-text black--text font-weight-bold text-justify">
          O psicólogo irá te auxiliar na busca por novos caminhos a serem
          trilhados, com o intuito de alcançar seus objetivos; utilizando de
          escuta sem julgamentos, empatia e acolhimento, além de técnicas
          comportamentais baseadas em evidências.
        </p>

        <p class="main-text black--text font-weight-bold text-justify">
          No nosso projeto, contamos também com psicólogos que possuem pós
          graduação em terapia de casal, sendo assim, o projeto abarca casais
          que precisem de psicoterapia com este objetivo.
        </p>

        <p class="main-text black--text font-weight-bold text-justify">
          <strong
            >Se seu objetivo for apenas psicoterapia individual, se inscreva
            através do formulário no fim da página.</strong
          >
        </p>

        <p class="main-text black--text font-weight-bold text-justify">
          Caso o atendimento seja para casal, inscreva-se através do formulário
          abaixo:
        </p>

        <v-btn
          class="mt-5 mb-14 mb-md-5 subscribe-btn"
          color="primary"
          style="font-weight: bold; color:white;"
          href="https://docs.google.com/forms/d/e/1FAIpQLSfFJJ3fQbypv95pxyihUSqZuPaCCWxHMARnz6bpOp0bcN1Vqw/viewform"
          target="_blank"
          >INSCREVA-SE PARA TERAPIA DE CASAL</v-btn
        >
      </div>
    </div>
    ...
    >
      ...
      <div class="d-flex flex-column py-6 px-8 ml-md-10 col-content-end">
        ...
        <p class="main-text white--text text-justify mt-3">
        ...
        <p class="main-text white--text text-justify">
          ...
          entre 45 e 50 minutos, semanalmente, e serão agendadas de acordo com a
          disponibilidade de agenda das psicólogas.
        </p>
        ...
        <v-btn
          ...
          target="_blank"
          >INSCREVA-SE PARA PSICOTERAPIA INDIVIDUAL</v-btn
        >
      </div>
    </div>
